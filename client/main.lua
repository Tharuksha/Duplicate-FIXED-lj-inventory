...
RegisterNUICallback('UpdateStashData', function()
...
RegisterNUICallback('UpdateGloveboxData', function()
...
RegisterNUICallback('UpdateDropData', function()
    TriggerServerEvent("inventory:server:SaveInventory", "drop", CurrentDrop)
end)

RegisterNUICallback('Updateplayer', function()
...
RegisterNUICallback("ResetWeaponSlot", function(data)
    TriggerServerEvent("inventory:client:CheckWeapon", data.slotToCheck, data.newSlot)
end)
